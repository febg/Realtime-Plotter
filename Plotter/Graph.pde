...
/*   =================================================================================       
  ...
  for (int x=0; x<a.length; x++){                 // of the array, adjust them 
   ...
   /*  =========================================================================================
      ...
      void FfLineGraph(float[] x ,float[] y) {
      ...
      void FLineGraph(ArrayList<Float> ax, ArrayList<Float> ay){
          Float[] px = ax.toArray(new Float[ay.size()]);
          Float[] y = ay.toArray(new Float[ay.size()]);
          Float[] x = new Float[ay.size()];
